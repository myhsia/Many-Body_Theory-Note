...
\section{Change-neutral Fermi Liquid (With short range interaction: $\mathtt{\sim 1/r^6}$)}
...
Consider the time derivative of the number variable
\begin{equation}
  \odv*{\delta n_p(\bm r, t)}t = 0 \qq{or} \identity[\delta n_p]
\end{equation}
\begin{enumext}
  \item $\odv*{\delta n_p(\bm r, t)}t = 0$: Collisionless limit, $T \to 0$.
  \item $\odv*{\delta n_p(\bm r, t)}t = \identity[\delta n_p]$: Collision
  integral: Inelastic CMP scattering (decay), or interaction V.s. collision
\end{enumext}
