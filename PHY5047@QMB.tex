...
\setlength \feynhandlinesize {.8pt}
\usepackage[natbib, style = phys, biblabel = brackets, sorting = none]{biblatex}
\addbibresource{reference.bib}
\usepackage{zref-clever, simpler-wick, slashed, transparent, dsfont}
...
\include{./context/a_.tex}
\newweek
\include{./context/weekb_[2025-11-18]}
\newweek
\include{./context/weekc_[2025-11-25]}
\newweek
\include{./context/weekd_[2025-12-02]}
\include{./context/b_.tex}
\appendix
\sidefoot \thepage
